...
exec 'hi CursorColumn ctermbg=' . s:black_light . ' ctermfg=' . s:none . ' cterm=' . s:none

" the screen line that the cursor is in when 'cursorline' is set
exec 'hi CursorLine ctermbg=' . s:black_light . ' ctermfg=' . s:none . ' cterm=' . s:none

" Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
exec 'hi CursorLineNr ctermbg=' . s:black . ' ctermfg=' . s:white . ' cterm=' . s:none

" directory names (and other special names in listings)
exec 'hi Directory ctermbg=' . s:black . ' ctermfg=' . s:blue . ' cterm=' . s:none

" diff mode: Added line
exec 'hi DiffAdd ctermbg=' . s:black_light . ' ctermfg=' . s:green . ' cterm=' . s:none

" diff mode: Changed line
exec 'hi DiffChange ctermbg=' . s:black_light . ' ctermfg=' . s:yellow . ' cterm=' . s:none

" diff mode: Deleted line
exec 'hi DiffDelete ctermbg=' . s:black_light . ' ctermfg=' . s:red . ' cterm=' . s:none

" diff mode: Changed text within a changed line
exec 'hi DiffText ctermbg=' . s:black_light . ' ctermfg=' . s:blue . ' cterm=' . s:none
...
" more-prompt
exec 'hi MoreMsg ctermbg=' . s:green . ' ctermfg=' . s:black . ' cterm=' . s:none
...
exec 'hi NonText ctermbg=' . s:black_light . ' ctermfg=' . s:white_light . ' cterm=' . s:none

" normal text
exec 'hi Normal ctermbg=' . s:black . ' ctermfg=' . s:white_light . ' cterm=' . s:none

" Popup menu: normal item.
exec 'hi Pmenu ctermbg=' . s:white_light . ' ctermfg=' . s:black_light . ' cterm=' . s:none

" Popup menu: selected item.
exec 'hi PmenuSel ctermbg=' . s:white . ' ctermfg=' . s:black_light . ' cterm=' . s:none
...
exec 'hi SpecialKey ctermbg=' . s:black . ' ctermfg=' . s:white_light . ' cterm=' . s:none
...
exec 'hi TabLineSel ctermbg=' . s:white . ' ctermfg=' . s:black_light . ' cterm='. s:bold
...
" warning messages
exec 'hi WarningMsg ctermbg=' . s:yellow . ' ctermfg=' . s:black . ' cterm=' . s:none

" current match in 'wildmenu' completion
" the 'wildmenu' is the menu you hit TAB when entering a ':[command]'
exec 'hi WildMenu ctermbg=' . s:white . ' ctermfg=' . s:black . ' cterm=' . s:none
...
" set.
exec 'hi Menu ctermbg=' . s:white . ' ctermfg=' . s:black . ' cterm=' . s:none
...
" empty, and as such it is tied to the current when
" set.
exec 'hi Tooltip ctermbg=' . s:white . ' ctermfg=' . s:black . ' cterm=' . s:none


" any comment
exec 'hi Comment ctermbg=' . s:black . ' ctermfg=' . s:white . ' cterm=' . s:none

" any constant
exec 'hi Constant ctermbg=' . s:black . ' ctermfg=' . s:blue . ' cterm=' . s:none
...
" any variable name
exec 'hi Identifier ctermbg=' . s:black . ' ctermfg=' . s:cyan . ' cterm=' . s:none
" Function function name (also: methods for classes)
exec 'hi Function ctermbg=' . s:black . ' ctermfg=' . s:red_light . ' cterm=' . s:none

" any statement
exec 'hi Statement ctermbg=' . s:black . ' ctermfg=' . s:green . ' cterm=' . s:none
...
exec 'hi PreProc ctermbg=' . s:black . ' ctermfg=' . s:yellow_light . ' cterm=' . s:none
...
" int, long, char, etc.
exec 'hi Type ctermbg=' . s:black . ' ctermfg=' . s:yellow . ' cterm=' . s:none
" StorageClass static, register, volatile, etc.
" Structure  struct, union, enum, etc.
" Typedef  A typedef

" any special symbol
exec 'hi Special ctermbg=' . s:black . ' ctermfg=' . s:red . ' cterm=' . s:none
...
exec 'hi Underlined ctermbg=' . s:black . ' ctermfg=' . s:white_light . ' cterm=underline'
